...
{
    public class OrderGameRemovedNotificationHandler : BaseNotificationHandler<GameRemovedFromOrderEvent>
    {
        private readonly IOrderService _orderService;

        private readonly IServiceBusClient _serviceBusClient;

        public OrderGameRemovedNotificationHandler(
            ILogger<GameRemovedFromOrderEvent> logger,
        ...
        protected override async Task ExecuteAsync(GameRemovedFromOrderEvent request, CancellationToken ct)
        {
